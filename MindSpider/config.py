...
class Settings(BaseSettings):
    ...
    DB_HOST: str = Field("rm-wz98aq26ikzp9p751to.mysql.rds.aliyuncs.com", description="数据库主机名或IP地址")
    ...
    MINDSPIDER_API_KEY: Optional[str] = Field("sk-a30d9ed6ab4545889655de0d0dccf529", description="MINDSPIDER API密钥")
