...
class Settings(BaseSettings):
    ...
    DB_HOST: Optional[str] = Field("rm-wz98aq26ikzp9p751to.mysql.rds.aliyuncs.com", description="数据库主机")
    DB_USER: Optional[str] = Field("spider", description="数据库用户名")
    DB_PASSWORD: Optional[str] = Field("&A$PT!n*MWVEd!_5", description="数据库密码")
    DB_NAME: Optional[str] = Field("media_crawler", description="数据库名称")
